...
def main():
    ...
    if price and change:
        ...
        ema_21 = get_stop_loss(stock_symbol, ema_days=[21]).get(21)
        
        if ema_21 and cmp < ema_21:
            print("CMP is below the 21 EMA. The risk cannot be calculated.")
            return
        ...
        if error:
            ...
            if option == "1":
                ...
                if ema_stop_losses:
                    ...
                    selected_days = input("Enter the EMA days you want to use (choose from 5, 7, 9, 12, 15, 18, 21): ").strip()
                    try:
